...
<ul>The world needs resources. That will not change in the forseeable future. What we can change, however, is the way in which we find and exploit these resources. It is hypothesised that many of Earth's 'easy-to-reach' resources have been found, forcing exploration geologists to dig deeper and search in more remote parts of the world.</ul>

<ul>The concept of <emph>mining</emph> or <emph>exploitation</emph> is villainised in the media and shackled to negative connotations by the public. The reality is that we use an all manner of mined resources in our day-to-day life, and that isn't about to change. That being said, sustainability is at the heart of the modern mining ethos. If new resources are becomming more difficult to find, we are left with two options: (1) make more out of the resources we have or (2) get better at looking for new ones.</ul>
